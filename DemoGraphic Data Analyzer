...
def calculate_demographic_data(print_data=True):
  ...
  highest_earning_country_percentage = highest_earning_country.groupby('native-country')['native-country'].count()/df.groupby('native-country')['native-country'].count() *100

  # Identify the most popular occupation for those who earn >50K in India.
  top_IN_occupation = df[(df['native-country']=='India' & df['salary']=='>50k')]['occupation'].value_count().keys()[0]
